const routes = [
  {
    ...
    children: [
      ...
      { path: 'aranceles-internacion', name: 'aranceles-internacion', component: () => import('pages/internaciones/ArancelesInternacion.vue'), meta: { requiresAuth: true } },
      ...
      { path: 'activos-fijos', name: 'activos-fijos', component: () => import('pages/activos-fijos/ActivosFijos.vue'), meta: { requiresAuth: true } },
      { path: 'activos-fijos/funcionarios', name: 'activos-fijos-funcionarios', component: () => import('pages/activos-fijos/ActivosFuncionarios.vue'), meta: { requiresAuth: true } },
      { path: 'activos-fijos/funcionarios/:id', name: 'activos-fijos-funcionario', component: () => import('pages/activos-fijos/ActivoFuncionarioDetalle.vue'), meta: { requiresAuth: true } },
      { path: 'activos-fijos/detalle/:id', name: 'activo-fijo-detalle', component: () => import('pages/activos-fijos/ActivoDetalle.vue'), meta: { requiresAuth: true } },
