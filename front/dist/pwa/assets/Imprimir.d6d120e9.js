...
</html>`,document.getElementById("myElement").innerHTML=d,new P().print(document.getElementById("myElement")),n(c)}).catch(c=>{r(c)})})}static nota(t,n=!0){return console.log("factura",t),new Promise((r,o)=>{const i=this.numeroALetras(parseFloat(t.total).toFixed(2)),s={errorCorrectionLevel:"M",type:"png",quality:.95,width:100,margin:1,color:{dark:"#000000",light:"#FFF"}};x().env,M.toDataURL(`Fecha: ${t.fecha_emision} Monto: ${parseFloat(t.total).toFixed(2)}`,s).then(l=>{let a="",c="";t.producto&&(a="<tr><td class='titder'>PRODUCTO:</td><td class='contenido'>"+t.producto+"</td></tr>"),t.cantidad&&(c="<tr><td class='titder'>CANTIDAD:</td><td class='contenido'>"+t.cantidad+"</td></tr>");let d=`${this.head()}
  <!--div style='padding-left: 0.5cm;padding-right: 0.5cm'>
