...
</html>`,document.getElementById("myElement").innerHTML=d,new S().print(document.getElementById("myElement")),n(c)}).catch(c=>{r(c)})})}static nota(t,n=!0){return console.log("factura",t),new Promise((r,o)=>{const i=this.numeroALetras(parseFloat(t.total).toFixed(2)),s={errorCorrectionLevel:"M",type:"png",quality:.95,width:100,margin:1,color:{dark:"#000000",light:"#FFF"}};x().env,F.toDataURL(`Fecha: ${t.fecha_emision} Monto: ${parseFloat(t.total).toFixed(2)}`,s).then(l=>{let a="",c="";t.producto&&(a="<tr><td class='titder'>PRODUCTO:</td><td class='contenido'>"+t.producto+"</td></tr>"),t.cantidad&&(c="<tr><td class='titder'>CANTIDAD:</td><td class='contenido'>"+t.cantidad+"</td></tr>");let d=`${this.head()}
  <!--div style='padding-left: 0.5cm;padding-right: 0.5cm'>
...
${a}
${c}
</table><hr><div class='titulo'>DETALLE</div>`;t.venta_detalles.forEach(h=>{var u;console.log("r",h),d+=`<div style='font-size: 12px'><b> ${(u=h.producto)==null?void 0:u.nombre} </b></div>`,d+=`<div>
...
</html>`,document.getElementById("myElement").innerHTML=d,n&&new S().print(document.getElementById("myElement")),r(l)}).catch(l=>{o(l)})})}static reciboCompra(t,n=!0){return new Promise((r,o)=>{var c,d;const i=this.numeroALetras(parseFloat(t.total).toFixed(2)),s={errorCorrectionLevel:"M",type:"png",quality:.95,width:100,margin:1,color:{dark:"#000000",light:"#FFF"}},l=((c=t.proveedor)==null?void 0:c.nombre)||t.nombre||"",a=((d=t.proveedor)==null?void 0:d.ci)||t.ci||"";F.toDataURL(`Fecha: ${t.fecha} Monto: ${parseFloat(t.total).toFixed(2)}`,s).then(h=>{var f;let u=`${this.head()}
<html lang="es">
<head>
  <meta charset="UTF-8">
  <style>
...
<div class="mono">
  ...
  <table>
    <tr><td class='titder'>ID:</td><td class='contenido'>${t.id}</td></tr>
    <tr><td class='titder'>PROVEEDOR:</td><td class='contenido'>${l}</td></tr>
    <tr><td class='titder'>CI/NIT:</td><td class='contenido'>${a}</td></tr>
    <tr><td class='titder'>FECHA:</td><td class='contenido'>${t.fecha}</td></tr>
    <tr><td class='titder'>HORA:</td><td class='contenido'>${t.hora}</td></tr>
    <tr><td class='titder'>TIPO PAGO:</td><td class='contenido'>${t.tipo_pago}</td></tr>
    <tr><td class='titder'>FACTURA:</td><td class='contenido'>${(f=t.nro_factura)!=null?f:""}</td></tr>
  </table>
  <hr>
  <div class='titulo'>DETALLE DE PRODUCTOS</div>`;t.compra_detalles.forEach(g=>{u+=`
        <div><b>${g.nombre}</b></div>
        <div>
          <span style='font-size: 18px;font-weight: bold'>${g.cantidad}</span>
          <span> x ${parseFloat(g.precio).toFixed(2)} Bs</span>
          <span style='float:right'>${parseFloat(g.total).toFixed(2)} Bs</span>
        </div>
        <div style="font-size: 12px">
          Lote: ${g.lote||"-"} | Vence: ${g.fecha_vencimiento||"-"}
        </div>
        `}),u+=`<hr>
      <table>
        <tr><td class='titder'>TOTAL Bs</td><td class='titder'>${parseFloat(t.total).toFixed(2)}</td></tr>
      </table>
      <br>
      <div>Son: ${i} ${((parseFloat(t.total)-Math.floor(parseFloat(t.total)))*100).toFixed(2)}/100 Bolivianos</div>
      <hr>
      <div style='display: flex; justify-content: center;'>
        <img src="${h}" style="width: 75px; height: 75px;" />
      </div>
</div>
</body>
</html>`,document.getElementById("myElement").innerHTML=u,n&&new S().print(document.getElementById("myElement")),r(h)}).catch(h=>o(h))})}static cotizacion(t,n,r,o,i=!0){return(o==null||o==="")&&(o=0),new Promise((s,l)=>{const a=conversor.conversorNumerosALetras,d=new a().convertToText(parseInt(r)),h=Yt().format("YYYY-MM-DD"),u={errorCorrectionLevel:"M",type:"png",quality:.95,width:100,margin:1,color:{dark:"#000000",light:"#FFF"}},f=x().env;F.toDataURL(`Fecha: ${h} Monto: ${parseFloat(r).toFixed(2)}`,u).then(g=>{let p=`${this.head()}
  <div style='padding-left: 0.5cm;padding-right: 0.5cm'>
  <img src="logo.png" alt="logo" style="width: 100px; height: 50px; display: block; margin-left: auto; margin-right: auto;">
...
</html>`,document.getElementById("myElement").innerHTML=p,i&&new S().print(document.getElementById("myElement")),s(g)}).catch(g=>{l(g)})})}static notaCompra(t){return console.log("factura",t),new Promise((n,r)=>{const o=conversor.conversorNumerosALetras,s=new o().convertToText(parseInt(t.total)),l={errorCorrectionLevel:"M",type:"png",quality:.95,width:100,margin:1,color:{dark:"#000000",light:"#FFF"}},a=x().env;F.toDataURL(`Fecha: ${t.fecha_emision} Monto: ${parseFloat(t.total).toFixed(2)}`,l).then(async c=>{let d=`${this.head()}
  <div style='padding-left: 0.5cm;padding-right: 0.5cm'>
  <img src="logo.png" alt="logo" style="width: 100px; height: 50px; display: block; margin-left: auto; margin-right: auto;">
...
</html>`,document.getElementById("myElement").innerHTML=d,new S().print(document.getElementById("myElement")),n(c)}).catch(c=>{r(c)})})}static reportTotal(t,n){const r=t.filter(s=>s.tipoVenta==="Ingreso").reduce((s,l)=>s+l.montoTotal,0),o=t.filter(s=>s.tipoVenta==="Egreso").reduce((s,l)=>s+l.montoTotal,0),i=r-o;return console.log("montoTotal",i),new Promise((s,l)=>{const a=conversor.conversorNumerosALetras,c=new a,d=Math.abs(i),h=c.convertToText(parseInt(d)),u={errorCorrectionLevel:"M",type:"png",quality:.95,width:100,margin:1,color:{dark:"#000000",light:"#FFF"}},f=x().env;F.toDataURL(` Monto: ${parseFloat(i).toFixed(2)}`,u).then(g=>{let p=`${this.head()}
  <div style='padding-left: 0.5cm;padding-right: 0.5cm'>
...
<table>
...
</html>`,document.getElementById("myElement").innerHTML=p,new S().print(document.getElementById("myElement")),s(g)}).catch(g=>{l(g)})})}static reciboCompra2(t){return new Promise((n,r)=>{const o=conversor.conversorNumerosALetras,s=new o().convertToText(parseInt(t.total)),l={errorCorrectionLevel:"M",type:"png",quality:.95,width:100,margin:1,color:{dark:"#000000",light:"#FFF"}},a=x().env;F.toDataURL(`Fecha: ${t.date} Monto: ${parseFloat(t.total).toFixed(2)}`,l).then(c=>{let d=`${this.head()}
    <div style='padding-left: 0.5cm;padding-right: 0.5cm'>
    <img src="logo.png" alt="logo" style="width: 100px; height: 100px; display: block; margin-left: auto; margin-right: auto;">
      <div class='titulo'>RECIBO DE COMPRA</div>
      <div class='titulo2'>${a.razon} <br>
    ...
    </html>`,document.getElementById("myElement").innerHTML=d,new S().print(document.getElementById("myElement")),n(c)}).catch(c=>{r(c)})})}static reciboTranferencia(t,n,r,o){return console.log("producto",t,"de",n,"ha",r,"cantidad",o),new Promise((i,s)=>{const l=conversor.conversorNumerosALetras,c=new l().convertToText(parseInt(o)),d={errorCorrectionLevel:"M",type:"png",quality:.95,width:100,margin:1,color:{dark:"#000000",light:"#FFF"}},h=x().env;F.toDataURL(`de: ${n} A: ${r}`,d).then(u=>{let f=`${this.head()}
    <div style='padding-left: 0.5cm;padding-right: 0.5cm'>
    <img src="logo.png" alt="logo" style="width: 100px; height: 100px; display: block; margin-left: auto; margin-right: auto;">
    ...
    </html>`,document.getElementById("myElement").innerHTML=f,new S().print(document.getElementById("myElement")),i(u)}).catch(u=>{s(u)})})}static head(){return`<html>
<style>
      .titulo{
      font-size: 12px;
      text-align: center;
