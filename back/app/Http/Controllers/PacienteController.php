...
class PacienteController extends Controller{
    ...
    function show(Paciente $paciente){
        return Paciente::with('historialMedicos.user','signosVitales.user','antecedentesFamiliares.user','habitosPersonales.user','recetas.user','recetas.recetaDetalles.producto','diagnosticos.user')->find($paciente->id);
    }
