...
Route::get('/caja-recepciones/pdf-farmacia', [App\Http\Controllers\CajaRecepcionController::class, 'pdfFarmacia']);
Route::get('/caja-recepciones/pdf-honorarios', [App\Http\Controllers\CajaRecepcionController::class, 'pdfHonorarios']);
...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::get('/ventas/excel', [App\Http\Controllers\VentaController::class, 'ventasExcel']);
    ...
    Route::get('/caja-recepciones/excel', [App\Http\Controllers\CajaRecepcionController::class, 'excel']);
